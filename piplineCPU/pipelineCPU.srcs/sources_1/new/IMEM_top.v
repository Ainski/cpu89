...
module IMEM_top(
    ...
    initial begin
        $readmemh("E:/Homeworks/ComputerSytemExperiement/cpu89/test_scripts/testdata/104_pizza_tower_test.hex.txt", IMEMreg);        //$readmemh("E:/Homeworks/cpu31real/testdata/2_addiu.hex.txt", IMEMreg);
