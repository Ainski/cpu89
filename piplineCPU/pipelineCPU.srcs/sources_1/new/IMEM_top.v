...
module IMEM_top(
    ...
    initial begin
        $readmemh("E:/Homeworks/ComputerSytemExperiement/cpu89/test_scripts/testdata/71_sc.hex.txt", IMEMreg);        //$readmemh("E:/Homeworks/cpu31real/testdata/7_xori.hex.txt", IMEMreg);
